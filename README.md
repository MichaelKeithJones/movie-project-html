...
**The Movie Database (TMDB) API**: https://www.themoviedb.org/documentation/api?language=en-US<br>
**Font Awesome 4.7**: https://fontawesome.com/v4/examples/<br>
**Google Fonts**: https://fonts.google.com/specimen/Montserrat<br>
